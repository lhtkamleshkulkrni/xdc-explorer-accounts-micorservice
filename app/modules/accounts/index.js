...
export default class AccountController{
    ...
    async getAccountRanking(request,response){
        ...
        if (error) {
            ...
            return Utils.handleErrorForAccountRanking({message:"Invalid Address"}, request, response);
        }
        return Utils.responseForAccountRanking(response, accountDetailsResponse, apiSuccessMessage.ACCOUNT_RANKING_FETCH_SUCCESSFULLY, httpConstants.RESPONSE_STATUS.SUCCESS, httpConstants.RESPONSE_CODES.OK);
    }
